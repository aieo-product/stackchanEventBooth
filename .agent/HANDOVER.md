...
## 今いちばん大事な状態 🔥
- **印刷分担(7/23午後確定)**: 応援=リム4＋**支柱4点＋base×2**(/dl/wheel-kit-20260723.zip・明朝神田受渡)。自宅=リム残→hub×2＋crank→**夜仕込み: LT会ブース一式(0.6ノズル・床=ウッド・壁=白)**。**608ベアリング不使用で確定**(支柱Φ9穴が滑り軸受・千石リストの608は購入不要に)
