...
## 進行中 🚧
- **観覧車（#12）/ 撮影ブース3Dプリント化（#13）**: PR #14/#15 マージ済み・本番デプロイ済み（/ferris-wheel, /photobooth）
  - **観覧車は手回しクランク版に確定（2026-07-15）**: モーター系実売¥7,131が閾値超過のため電動をドロップ。追加発注3点約¥6,200・経費合計約¥19,300
  - **要発注（Amazon・BOM表にリンク有）**: 8mmシャフト¥1,180／WS2812B 5m ¥3,369（or 秋月SK6812×2店頭）／Φ3丸棒+Eリング¥1,639。**金属丸棒2種は秋葉原両店で取扱なし→Amazon必須**
  - 秋葉原店頭で即入手可: 秋月SK6812テープLED／千石EW3 Eリング（本店2階）／千石608ZZ（本店3階・7/13注文遅延時の保険）
  - 完成予想図（AI生成CG・手回し版）掲載済み
- 追加調査: `research/makerworld-props-20260715.md`（小物26件）/ `research/amazon-parts-20260715.md`（Amazon+秋月千石）
- 物理作業: パーツ発注（即）→CAD→7/19 LED点灯テスト+仮合わせ→7/22本組立（7/13注文分が7/20-22着のため）。印刷95h/9日・1日12h枠（日別表は/ferris-wheel）
- プランB: CADが7/18までに間に合わなければ espRyk観覧車(makerworld 911733・手回し版862148)＋ミニスタックチャン搭乗へ切替
