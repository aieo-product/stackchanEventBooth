...
> AI生成の完成イメージ（2026-07-15）。実設計はゴンドラ**4基**・リムØ300・接地350×250（下記仕様）。雰囲気・配色（白リム＋半透明ディフューザー＋パステルゴンドラ＋グレー支柱）の共有用。
...
|--:|---|---|---|--:|---|
| 1 | ウォームギヤードモーター | BRINGSMART JGY-370 12V **3rpm**（セルフロック・★4.2/81件） | 🛒 電動版のみ | ¥2,429 | [dp/B01HGCSBDM](https://www.amazon.co.jp/dp/B01HGCSBDM)（[6rpm版](https://www.amazon.co.jp/dp/B08MSYS1SD)も同価格） |
| 2 | ACアダプタ 12V 2A | Broadwatch 5.5×2.1mm（★3.9/229件） | 🛒 電動版のみ | ¥1,380 | [dp/B00AJDAPM6](https://www.amazon.co.jp/dp/B00AJDAPM6) |
| 3 | PWM速度コントローラ | beyourchoi DC1.8〜15V 2A（6個セット・★4.2/76件） | 🛒 電動版のみ | ¥749 | [dp/B0CX55SRYM](https://www.amazon.co.jp/dp/B0CX55SRYM) |
| 4 | ロッカースイッチ＋DCジャック | LIANHATA 2ピン5個（¥575）＋Youmile DC-099 5.5×2.1 10個（¥999） | 🛒 電動版のみ | ¥1,574 | [dp/B0DG8R497X](https://www.amazon.co.jp/dp/B0DG8R497X) / [dp/B08SM3BY7L](https://www.amazon.co.jp/dp/B08SM3BY7L) |
...
| 7 | シャフトカプラ 6→8mm | Saipor フレキシブルビームカップリング 5個（★4.3/21件） | 🛒 電動版のみ | ¥999 | [dp/B07ZMYSYLH](https://www.amazon.co.jp/dp/B07ZMYSYLH) |
...
| | | | **追加発注合計（実売）** | **電動版 約¥13,300 ／ 手回し版 約¥6,200** | |

::: warning 実売調査での判明事項（2026-07-15）
- **モーター系5点（#1〜4・7）の実売合計は¥7,131**で、切替閾値（¥6,000）を**超過** → 電動/手回しの最終判断が必要（下記比較参照）。
...
**切替判断**: 実売調査（2026-07-15）の結果、モーター系5点の合計は**¥7,131で閾値¥6,000を超過** → **電動（＋¥7,131・展示映え優先）か手回し（参加型・約半額）かの最終判断待ち**。実売が高いのはセット販売（PWM6個・ジャック10個等）のためで、単価ベースの差はより小さい点は考慮の余地あり。ホイール本体の印刷はどちらでも共通なので、判断を待たずに印刷を開始できます。
...
| 日付 | 印刷内容 | 目安時間 | 並行作業 |
|---|---|--:|---|
| 7/15(火) | テスト印刷（リム円弧1・ゴンドラ1・床タイル1） | 5.0h | **電装パーツ発注** / CADモデリング |
| 7/16(水) | 観覧車 リム円弧×4＋ハブ×2 | 11.8h | CAD残り（支柱・ベース） |
| 7/17(木) | 観覧車 リム円弧×3＋ディフューザー×8 | 11.4h | LEDスケッチ作成 |
| 7/18(金) | 観覧車 支柱×4＋ゴンドラ×1 | 10.6h | 追加発注分（モーター・シャフト・LED）着荷確認・**プランB切替判断** |
| 7/19(土) | 観覧車 ベース×2＋モーターマウント＋ゴンドラ×2 → **電装単体テスト＋仮合わせ**（LED点灯・モーター回転・パーツ嵌合。※ベアリング/インサートは7/20〜22着のため軸組みは除く） | 12.0h | 電装テスト |
