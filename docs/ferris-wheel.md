...
| ゴンドラ | 4 | 85×85×110 | 40 | 1.8h | **PLAグラディエント 綿菓子の雲**（ピンク→水色グラデ／7/17購入） |
...
| 7/17(木) | 観覧車 リム円弧×3＋支柱×2 | 11.0h | **Bambuフィラメント購入（木曜ポイント2倍）**: グラディエント・PETGクリア等5本 ¥11,492 |
| 7/18(金) | 観覧車 支柱×2＋ベース×2 | 10.4h | シャフト着荷／**プランB切替判断**（CADは完了済のため原則プランA続行） |
| 7/19(土) | クランク一式＋**ゴンドラ×3（グラディエント）**＋ディフューザー×4（PETGクリア・要乾燥） → **LED点灯テスト＋仮合わせ** | 10.3h | フィラメント着荷確認・LEDテスト |
...
> 7/17購入のグラディエント/PETGは7/18〜19着見込みのため、ゴンドラ本番とディフューザーを7/19以降に配置（それまで共通部品を先行印刷）。PETGは印刷前に乾燥させること。
