...
> #1〜8・11・12 は**7/16までに発注**（Prime翌日着前提）。届くまでは印刷を先行し、7/19の仮組立に間に合わせる。#1〜4・7 は電動版のみ必要（下記比較参照）。
...
| 追加パーツ費 | **約¥9,800** | **約¥5,000**（モーター¥1,600・ACアダプタ¥1,300・PWM¥700・スイッチ¥600・カプラ¥600 ＝ ▲¥4,800） |
| 残るパーツ | — | ベアリング・シャフト・LEDテープ・ネジ類・ゴンドラ軸（¥5,000分） |
...
| 7/18(金) | 観覧車 支柱×4＋ゴンドラ×1 | 10.6h | 電装パーツ着荷確認・**プランB切替判断** |
| 7/19(土) | 観覧車 ベース×2＋モーターマウント＋ゴンドラ×2 → **仮組立・回転/LEDテスト** | 12.0h | 組立・電装テスト |
| 7/20(日) | 撮影ブース 床タイル×7＋壁パネル×6 | 11.3h | ジオラマ装飾素材の画像作成・印刷 |
| 7/21(月) | 撮影ブース 壁パネル×2＋スタンド類＋MakerWorld小物4点 | 10.9h | 100均で装飾調達 |
| 7/22(火) | アクセサリー優先分（帽子・ヘッドホン・猫耳・キーホルダー） | 12.0h | リテイク枠 |
