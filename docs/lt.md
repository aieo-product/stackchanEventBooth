...
> 旧Marp版 [`slides/lt-stackchan-ai-agent.md`](https://github.com/aieo-product/stackchanEventBooth/blob/main/slides/lt-stackchan-ai-agent.md) は**旧構成（電子工作素人の苦労話＋レイテンシー主役）**のまま残置。内容の正はHTML版。
